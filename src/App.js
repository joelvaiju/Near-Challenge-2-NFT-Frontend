  ...
  if (!window.walletConnection.isSignedIn()) {
    return (
      <main>
        <h1>Hello There!</h1>
        <p>
          To Mint your NFT you need to sign in using NEAR wallet
        </p>
  ...
  return (
    ...
    <>
      ...
      <main>
        ...
        <div >
          <img src="https://bafybeibnrhpoitqkinikhyunzyi2pwj4d5ezqqwmziif3vap4bse7z64vm.ipfs.dweb.link/near.jpeg" width="550" height="400" />
        </div>
